            ...
            return(
              <div key={index} className='py-4 border-t border-b border-gray-300 text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                  <div className='flex items-start gap-6'>
                   ...
                   <input className="border border-gray-300 max-w-10 sm:max-w-20 px-1 sm:px-2 py-1 " type='number' onChange={(e)=>updateQuantity(item._id,item.size,Number(e.target.value))} min={1} defaultValue={item.quantity}/>
